...
extern "C" SRPDLLEXPORT int SRPAPI luaopen_libstarcore52( void *L );
#else
...
extern SRPDLLEXPORT int SRPAPI luaopen_libstarcore52( void *L );
#endif
#else
#if defined(__cplusplus) || defined(c_plusplus)
...
extern "C" SRPDLLIMPORT int SRPAPI luaopen_libstarcore52( void *L );
#else
...
extern SRPDLLIMPORT int SRPAPI luaopen_libstarcore52( void *L );
#endif
#endif
#else
...
extern int SRPAPI luaopen_libstarcore52( void *L );
#endif
