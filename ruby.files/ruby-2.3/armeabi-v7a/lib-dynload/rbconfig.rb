...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.3.0/arm-linux")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/android/install/ruby235.armeabi")
  ...
  CONFIG["configure_args"] = " 'LDFLAGS=-llog -lm -L../../../../../sqlite/android_3140100.armeabi/obj/local/armeabi -L../../../../../openssl.android.linux/install/openssl.armeabi/lib' 'CFLAGS=-mandroid -fomit-frame-pointer -Wno-format' 'CPPFLAGS=-I../../../../../sqlite/sqlite-autoconf-3140100 -I../../../../../openssl.android.linux/install/openssl.armeabi/include' '--host=arm-linux' '--build=i686-pc-linux-gnu' '--enable-shared' '--prefix=/usr/local/android/install/ruby235.armeabi' '--with-baseruby=/usr/bin/ruby' '--disable-ipv6' '--disable-rubygems' '--disable-install-doc' '--disable-install-rdoc' '--disable-install-capi' '--without-ext=fiddle' '--disable-rpath' 'build_alias=i686-pc-linux-gnu' 'host_alias=arm-linux' 'CC=arm-linux-androideabi-gcc -DANDROID -mandroid -fomit-frame-pointer --sysroot=/usr/local/android/android-ndk-r10d/platforms/android-9/arch-arm' 'CXX=arm-linux-androideabi-g++ -DANDROID -mandroid -fomit-frame-pointer --sysroot=/usr/local/android/android-ndk-r10d/platforms/android-9/arch-arm' 'CXXFLAGS=-DANDROID -mandroid -fomit-frame-pointer --sysroot=/usr/local/android/android-ndk-r10d/platforms/android-9/arch-arm'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/local/android/install/ruby235.armeabi"
